	...
	while 1:
		while f == 0:
			...
			try:	
				...
				df = 0
				if params[3] != 0:
					sdf = params[3] ##contains the count of packets the software will capture before quiting capture
				else:
					sdf = 100000 ##default count of packets captured if value isn't defined in the GUI
		## DEBUG PARAMS		
				##f = 2
				##s = ""
				##d = "192.168.69.24"
